...
public class FifthLevel {
    ...
    private ImageIcon image_5;
    private ImageIcon image_6;
    ...
    private void createGamePrepScreen() {
        ...
        this.image_6 = new ImageIcon("assets\\level\\lockedLevel.png");
        ...
        this.level6 = new JLabel(this.image_6);
        ...
        this.levelsFrame.add(levelsPanel);
