...
public class GameScene_6 {
    ...
    private Enemy e = new Enemy(250);
    private final int FRAME_WIDTH = 700;
    private final int FRAME_HEIGHT = 700;

    public GameScene_6(ImageIcon img) {
        this.avatar = img;
    ...
    private void createGameScene() {
        this.image = new ImageIcon("assets\\scene\\gameSceneBackground_6.png");
        ...
        this.gameScene.add(this.background);
    ...
    class HeroAttackButton implements ActionListener {
        public void actionPerformed(ActionEvent event) { h.attack(e); }
    }
